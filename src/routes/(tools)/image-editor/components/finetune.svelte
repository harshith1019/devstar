...
<div class="card gap-16 items-center mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 overflow-hidden rounded-lg">
    <div class="p-4">
        <div class="mb-4">
            <label for="brightness" class="block text-sm font-medium text-black">Brightness</label>
            <input type="range" id="brightness" class="filter-slider" min="0" max="200" bind:value={brightness} on:input={updateImage} />
        </div>

        <div class="mb-4">
            <label for="contrast" class="block text-sm font-medium text-black">Contrast</label>
            <input type="range" id="contrast" class="filter-slider" min="0" max="200" bind:value={contrast} on:input={updateImage} />
        </div>

        <div class="mb-4">
            <label for="exposure" class="block text-sm font-medium text-black">Exposure</label>
            <input type="range" id="exposure" class="filter-slider" min="-100" max="100" bind:value={exposure} on:input={updateImage} />
        </div>


        <div class="mb-4">
            <label for="gamma" class="block text-sm font-medium text-black">Gamma</label>
            <input type="range" id="gamma" class="filter-slider" min="0.1" max="10" step="0.1" bind:value={gamma} on:input={updateImage} />
        </div>

        <div class="mb-4">
            <label for="clarity" class="block text-sm font-medium text-black">Clarity</label>
            <input type="range" id="clarity" class="filter-slider" min="0" max="100" bind:value={clarity} on:input={updateImage} />
        </div>

        <div class="mb-4">
            <label for="vignette" class="block text-sm font-medium text-black">Vignette</label>
            <input type="range" id="vignette" class="filter-slider" min="0" max="100" bind:value={vignette} on:input={updateImage} />
        </div>

        <div class="mb-4">
            <label for="saturation" class="block text-sm font-medium text-black">Saturation</label>
